...
const ENENMYENCOUNTERS: Partial<Record<enemyWaveName, Encounter>> = {
	ORCS: new Encounter()
		...
		.addWave([[Enemies.orcMasked, 5], [Enemies.orcShaman, 5], [Enemies.orc, 10]], 3)
	...
	ELVES: new Encounter()
		...
		.addWave([[Enemies.leprechaun, 30], [Enemies.woodElfMale, 5], [Enemies.woodElfFemale, 5]], 5)
		.addWave([[Enemies.leprechaun, 20], [Enemies.woodElfMale, 10], [Enemies.woodElfFemale, 10]], 5)
		.addWave([[Enemies.elfKnight, 10], [Enemies.elfRanger, 5], [Enemies.leprechaun, 10], [Enemies.woodElfMale, 5], [Enemies.woodElfFemale, 5]], 3)
		.waitForEnemiesCleared()
