...
const ENENMYENCOUNTERS: Record<enemyWaveName, () => Encounter> = {
	ORCS: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(goblin).add(orc, 2).add(orcShaman).add(orcMasked), 30, 0.25, 3)
		.waitForEnemiesCleared()
		.addEnemy(orcBig)
		.addEnemy(orcBigPatch)
		.addWave(new WeightedList<EnemyType>().add(goblin).add(orc).add(orcShaman).add(orcMasked), 30, 0.3, 1)
		.waitForEnemiesCleared()
		.stop(),
	ANIMALS: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(bunny, 5).add(fox, 4).add(bear), 30, 0.2, 4)
		.waitForEnemiesCleared()
	...
	ELVES: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(woodElfFemale).add(woodElfMale).add(elfKnight, 2).add(elfRanger), 30, 0.25, 3)
		.waitForEnemiesCleared()
	...
	VILLAGERS: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(villagerFemale, 3).add(villagerMale, 3).add(butcher).add(blacksmith), 30, 0.2, 4)
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(villagerFemale).add(villagerMale).add(butcher).add(blacksmith), 30, 0.25, 3)
		.waitForEnemiesCleared()
	...
	PRIESTS: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(clericNormal, 2).add(clericFat, 2).add(clericSkinny, 2).add(templar, 3).add(inquisitor), 30, 0.2, 4)
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(clericNormal).add(clericFat).add(clericSkinny).add(templar, 2).add(inquisitor), 30, 0.25, 3)
		.waitForEnemiesCleared()
	...
	UNDEAD: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(zombieSmall).add(skeleton).add(swampy).add(muddy).add(iceZombie), 30, 0.25, 3)
		.waitForEnemiesCleared()
		.addEnemy(ogre)
	...
	DEMONS: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(imp).add(wogol, 2).add(chort).add(necromancer), 30, 0.25, 3)
		.waitForEnemiesCleared()
	...
	VAMPIRES: () => new Encounter()
		...
		.waitForEnemiesCleared()
		.addWave(new WeightedList<EnemyType>().add(bat).add(cultist).add(cultistHooded, 2).add(vampireMale).add(vampireFemale), 30, 0.25, 3)
		.waitForEnemiesCleared()
		.addEnemy(vampireLord)
		.addWave(new WeightedList<EnemyType>().add(bat).add(cultist).add(cultistHooded).add(vampireMale).add(vampireFemale), 30, 0.3, 1)
		.waitForEnemiesCleared()
		.stop(),
}
