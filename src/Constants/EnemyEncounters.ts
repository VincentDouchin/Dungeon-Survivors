...
const ENENMYENCOUNTERS: Partial<Record<enemyWaveName, () => Encounter>> = {
	...
	,
	ELVES: () => new Encounter()
		.addWave([[Enemies.leprechaun, 20], [berserk(Enemies.leprechaun), 5]], 5)
		.addWave([[Enemies.leprechaun, 20], [berserk(Enemies.leprechaun), 5], [Enemies.woodElfMale, 5], [Enemies.woodElfFemale, 5]], 5)
		.addWave([[Enemies.leprechaun, 10], [berserk(Enemies.woodElfMale), 5], [Enemies.woodElfMale, 10], [Enemies.woodElfFemale, 10], [berserk(Enemies.woodElfFemale), 5]], 4)
	...
	VILLAGERS: () => new Encounter()
		.addWave([[Enemies.villagerFemale, 10], [berserk(Enemies.villagerFemale), 3], [Enemies.villagerMale, 10], [berserk(Enemies.villagerMale), 3]], 5)
		.addWave([[berserk(Enemies.villagerFemale), 3], [berserk(Enemies.villagerMale), 3], [Enemies.villagerFemale, 5], [Enemies.villagerMale, 5], [Enemies.shopKeeper, 5], [berserk(Enemies.shopKeeper), 2]], 5)
		.addWave([[Enemies.butcher, 5], [berserk(Enemies.shopKeeper), 5], [Enemies.villagerFemale, 10], [Enemies.villagerMale, 10]], 5)
		.addWave([[Enemies.blacksmith, 5], [Enemies.shopKeeper, 5], [Enemies.butcher, 5], [Enemies.villagerFemale, 15], [Enemies.villagerMale, 15]], 5)
		.waitForEnemiesCleared()
		.addWave([[Enemies.executioner, 1], [Enemies.shopKeeper, 5], [Enemies.blacksmith, 5], [Enemies.butcher, 5]], 1)
		.waitForEnemiesCleared()
		.stop(),
